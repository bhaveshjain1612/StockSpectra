...
compiled.to_csv('backed_data/db_firmo.csv', index=False)
'''    
####################################################################################################################################################
#Financials
####################################################################################################################################################
...
def compile_single(symbol):
    ...
    compilation_adress = "backed_data/historical/"
...
db_firmo = pd.read_csv("backed_data/db_firmo.csv")
...
for i in tqdm(symbol_list):
    try:
        ...
        continue
kpi_df.to_csv("backed_data/historical_kpis.csv", index=False)
'''
####################################################################################################################################################
#Merging
#################################################################################################################################################### 
...
#reading data
firmo = pd.read_csv("backed_data/db_firmo.csv")
kpis = pd.read_csv("backed_data/historical_kpis.csv")
...
database.to_csv('backed_data/database.csv', index=False,mode='w')
print("Data Updated")