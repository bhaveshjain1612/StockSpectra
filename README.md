...
The Financial Dashboard comes equipped with several features to help you navigate the stock market effectively:
...
- **View Options**: Choose from three viewing options:
  - **Top Picks**: Displays the top-rated stocks with strong outlook and financials.
  - **All**: Shows all stocks based on applied filters.
  - **Potential Breakout**: Lists stocks that are potential breakout candidates (requires CSV file "backend_data/breakout.csv").
